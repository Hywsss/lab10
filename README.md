...
```sh
$ vagrant version
$ vagrant init bento/ubuntu-19.10 - инициализация Vagrantfile
$ less Vagrantfile
...
$ vagrant port - отображение портов
$ vagrant status
$ vagrant ssh

$ vagrant snapshot list 
$ vagrant snapshot push - пуш скриншота виртуальной машины 
$ vagrant snapshot list
